...
public class SendingEmailExample {
    public static Boolean sendMessage(String recipient, String link) {
        try {
...
//        return mailSender;
            ...
            message.setSubject("Check your account");
            ...
            String mess = String.format("<h1><a href='/%s'>Click to confirm your account</a></h1>", link);
    ...
    private static Session getSession(Properties newProperties, String username, String password) {
